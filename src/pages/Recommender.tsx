...
const Recommender = () => {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Hello! I'm your Uppsala University course recommender. Tell me about your interests, and I'll help you find the perfect courses. What field are you interested in studying?",
    },
  ]);
